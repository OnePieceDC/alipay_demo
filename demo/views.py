...
def withdraw(request):
    ...
    data_dict = res.json()
    # 直接告诉我们转账结果
    # {"alipay_fund_trans_uni_transfer_response":{"code":"10000","msg":"Success",
    # "order_id":"20221204110070000006260000848244","out_biz_no":"a3d634f4f15f1a289df250f588ccf4a9",
    # "pay_fund_order_id":"20221204110070001506260000849678","status":"SUCCESS"},
